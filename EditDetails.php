...
if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            if($stmt = mysqli_prepare($conn, $sql)){
                ...
                if(mysqli_stmt_execute($stmt)){
                    ...
                    if(mysqli_stmt_num_rows($stmt) > 1)
                        $ic_err = "An account with this ic number already exists.";
                    else if($param_ic < 0)
        ...
        if(isset($_POST["phone_no"]))
    {
        ...
        if(empty($ic_err) && empty($cust_name_err) && empty($email_err)&& empty($phone_no_err)){
            ...
            $sql = "UPDATE customer SET ic_no='$ic_no', cust_name='$cust_name', email='$email', phone_no='$phone_no', ic_no='$ic_no' WHERE users_id=$users_id";
            ...
            if($stmt = mysqli_prepare($conn, $sql)){
                ...
                if(mysqli_stmt_execute($stmt)){
                    echo "<script>alert('Update successful. Now you can continue.');window.location.href='UserMain.php';</script>"; 
                }
                else{
    ...
    <div class="wrapper-register">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method = "post">
            <div class="form-group <?php echo (!empty($ic_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="tel" name="ic_no" class="form-control" maxlength="12" value="<?php echo $ic_no; ?>" placeholder="Enter the number without (-) Example:123456789012">
            ...
            <div class="form-group <?php echo (!empty($email_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="text" name="email" class="form-control" maxlength="50" value="<?php echo $email; ?>">
            ...
            <div class="form-group <?php echo (!empty($phone_no_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="tel" name="phone_no" class="form-control" maxlength="15" value="<?php echo $phone_no; ?>">
            ...
            <h2><?php echo $check_err; ?><h2>
                ...
                <a style="text-decoration: none;padding: 2px 5px;margin-left: 100px;color: white;background: rgb(255, 17, 37);border: none;border-radius: 5px;text-align: center;font-family: 'Franklin Gothic Medium';font-size: 20px;" 
                href="UserMain.php">Cancel</a>
            </div>
        </form>
    </div>
