    ...
    <div class="wrapper-register">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method = "post">
            <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="text" name="username" class="form-control" maxlength="30" value="<?php echo $username; ?>">
                <span class="help-block"><font color="red"><?php echo $username_err; ?></font></span>
            </div>
            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                <label>Password</label><br>
                <input type="password" name="password" class="form-control" maxlength="50" value="<?php echo $password; ?>" placeholder="Minimum 6 characters.">
